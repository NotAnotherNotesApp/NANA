...
abstract class NanaDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        // Migration from version 9 to 10 - Add foreign key constraints
        private val MIGRATION_9_10 = object : Migration(9, 10) {
            override fun migrate(database: SupportSQLiteDatabase) {
                // Recreate note_images with foreign key
                ...
                // Recreate checklist_items with foreign key
                ...
                // Recreate routine_completions with foreign key
        ...
        // Migration from version 10 to 11 - Add FTS for notes
