...
object LabelColors {
    ...
    val categoryColors = listOf(
        0xFFF97316.toInt(),  // Orange - Food and Drinks
...
object PresetLabels {
    ...
    val expenseCategories = listOf(
        Label(name = "Food and Drinks", type = LabelType.EXPENSE, iconName = "restaurant", color = 0xFFF97316.toInt(), isPreset = true, sortOrder = 0),
